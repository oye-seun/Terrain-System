...
public class WaterMeshGenActive : MonoBehaviour
{
    private Mesh mesh;
    //public Vector3 pos;
    ...
    public DelauneyTriangulationActive _delauney;
    ...
    public void GenerateWaterMesh()
    {
        ...
        _delauney.SetDelauneyProperties(verts, supraTriangle);
        List<int> triangles = _delauney.Triangles;
...
[CustomEditor(typeof(WaterMeshGenActive))]
public class WaterMeshGenActiveEditor : Editor
{
    ...
    private WaterMeshGenActive WMG;
    ...
    private void OnEnable()
    {
        ...
        _delauney = serializedObject.FindProperty("_delauney");
